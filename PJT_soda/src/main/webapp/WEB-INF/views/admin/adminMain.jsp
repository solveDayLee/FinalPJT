...
.image-1 {
	background: linear-gradient(69.25deg, rgba(209, 107, 165, 0.3) 0%,
		rgba(134, 168, 231, 0.3) 51.73613429069519%, rgba(95, 251, 241, 0.3)
		100%);
	width: 1272px;
	height: 811px;
	position: absolute;
...
.rectangle-21 {
	background: linear-gradient(265.94deg, rgba(249, 132, 244, 1) 0%,
...
<body>
	<div class="home-page">
		...
		<img class="export" src="export0.png" /> <img class="ellipse-1"
			src="ellipse-10.png" />
		<div
			...
			<span> <span
				...
				class="welcome-to-our-application-click-button-below-to-start-the-program-span3">
					Click the button to start the administrator program </span>
			</span>
		</div>
		<div class="group-11">
			...
			<div class="get-s-started">
				<a href="${pageContext.request.contextPath }/admin/adminUserBoard">
					<div class="get-s-started2">Get Started</div>
				</a>
		...
		<img class="customer" src="customer0.png" /> <img
			class="dashboard-layout" src="dashboard-layout0.png" /> <img
			class="online-store" src="online-store0.png" />
	</div>
