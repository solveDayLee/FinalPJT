  ...
  <div class="block">
    ...
    <div class="form">
      ...
      <div class="input-group">
        ...
        <input type="text" id="postcode" placeholder="우편번호" v-model="zonecode" readonly><button type="button"
          @click="execDaumPostcode" value="우편번호 찾기">
          우편번호 찾기</button>
        <br>
        <input type="text" id="address" placeholder="주소" v-model="address" readonly><br>
      ...
      <div class="input-group">
        ...
        <input type="password" v-model="password" placeholder="비밀번호를 입력해주세요" id="password" @blur="checkPassword">
