		...
		<div class="rectangle-34">
			<div class="board-table-container">
				<table class="board-table">
					...
					<tbody>
						<c:forEach items="${reportedList}" var="board" varStatus="state">
							<tr
								onclick="location.href='${pageContext.request.contextPath}/board/adminReportBoardDetail?no=${board.boardNo}'">
								<td>${board.boardNo}</td>
								<td>${board.title}</td>
